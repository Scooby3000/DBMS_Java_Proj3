// MainInterface That Users Will Interact With:
    ...
    public static void main(String[] args) {
        while (true) {
            try {
                ...
                while (!valid) {
                    staffID = Input.getInt("Enter your staff ID (or 0 to exit): ");
                    if (staffID == 0) {
                        System.out.println("Exiting the system. Goodbye!");
                        DBManager.close(); // Close DB connection gracefully
                ...
                DBManager.close(); // Re-establish if needed inside loop
            }
